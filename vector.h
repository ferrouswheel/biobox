...
// This vector.h file is pretty similar to one
// given at Gamasutra.
...
public:
  ...
  // This function is defined in model.cc and is
  // not originally in this vector class... perhaps
  // remove one day?
	//  void Vector::unitVector(Point *p1, Point *p2)
